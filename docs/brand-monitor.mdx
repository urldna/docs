...
![](https://github.com/urldna/docs/blob/main/images/docs/brand_monitor.png?raw=true)
...
* To **remove a monitored brand**, users must contact urlDNA support ([contact us]("https://urldna.io/contact-us")).
