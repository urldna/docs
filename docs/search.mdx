...
* `category`: Page category (e.g., "Security"), **available to PREMIUM users only**
 
* `language`: Detected page language (e.g., "English"), **available to PREMIUM users only**

* `topic`: Page topics (e.g., "phishing detection"), **available to PREMIUM users only**
